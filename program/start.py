...
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("➕ Add Soshie to a Group ➕", url=f"https://t.me/{me_bot.username}?startgroup=true")
                ],[
                    InlineKeyboardButton("❓ Basic Guide", callback_data="user_guide")
                ],[
                    InlineKeyboardButton("♦️Commands", callback_data="command_list"),
                    InlineKeyboardButton("❤️ Maintatintor", url=f"https://t.me/{OWNER_USERNAME}")
                ],[
                    InlineKeyboardButton("👥 Soshie Support", url=f"https://t.me/{GROUP_SUPPORT}"),
                    InlineKeyboardButton("📣 Soshie Newsl", url=f"https://t.me/{UPDATES_CHANNEL}")
                ],[
                    InlineKeyboardButton("🌐 Source Code", url="https://github.com/Sithumdimalsha4/video-stream")
                ],
            ]
        ),
